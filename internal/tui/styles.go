...
func (s *Styles) initComponentStyles(colors themeColors) {
	...
	s.MenuItemActive = lipgloss.NewStyle().Foreground(colors.primary).Bold(true).Padding(0, 2)

	s.Input = lipgloss.NewStyle().BorderStyle(lipgloss.RoundedBorder()).Padding(0, 1)
	s.InputFocused = lipgloss.NewStyle().
		BorderStyle(lipgloss.RoundedBorder()).
		BorderForeground(colors.primary).
		Padding(0, 1)

	s.Button = lipgloss.NewStyle().Padding(0, 2).MarginRight(1)
	...
	s.Highlight = lipgloss.NewStyle().Foreground(colors.primary).Bold(true)
